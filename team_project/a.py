...
class App:
	...
	def __init__(self, window, window_title, video_source=0):
		...
		self.btn_snapshot=tkinter.Button(btn_frame, text="연결",width=20, command=self.snapshot, bg=self.from_rgb((52, 61, 70)), fg="white")
		self.btn_snapshot.pack(side="left", padx=10, pady=10)

		self.btn_proses=tkinter.Button(btn_frame, text="연결 시도 중단", width=10, command=None, bg=self.from_rgb((52, 61, 70)), fg="white")
		self.btn_proses.pack(side="left", padx=10, pady=10)

		self.btn_about=tkinter.Button(btn_frame, text="통화 종료", width=10, command=None, bg=self.from_rgb((52, 61, 70)), fg="white")
